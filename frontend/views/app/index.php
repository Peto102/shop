...
<div class="hero-slide owl-carousel site-blocks-cover">
    ...
    <div class="intro-section" id="intro1">
        <div class="container">
            <div class="row align-items-center">
...
<div class="site-section">
    <div class="container">
        <div class="row">
            <div class="col-md-6">
                <?=Html::img('@web/images/hero_22.jpg', ['class' => 'img-fluid'] )?>
            </div>
            <div class="col-md-6">
...
<div class="site-section bg-image overlay" id="intro3">
    <div class="container">
        <div class="row">
            <div class="col">
        ...
        <div class="row">
            <div class="col-md-6 col-lg-4 mb-4">
                <div class="service-39381">
                    ...
                    <?=Html::img('@web/images/hero_1.jpg', ['class' => 'img-fluid'])?>
                    <div class="p-4">
    ...
    <div class="container">
        <div class="row">
            <div class="col-md-7">
                ...
                <p><?=Html::img('@web/images/hero_1.jpg', ['class' => 'img-fluid'])?></p>
            </div>
            <div class="col-md-5">
...
<!--                        --><?//=Html::img('@web/images/person_1.jpg', ['class' => 'img-fluid'])?>
<!--                        <div class="social">-->
...
<!--                        --><?//=Html::img('@web/images/person_2.jpg', ['class' => 'img-fluid'])?>
<!--                        <div class="social">-->
<!--                            <a href="#"><span class="icon-facebook"></span></a>-->
<!--                            <a href="#"><span class="icon-twitter"></span></a>-->
<!--                            <a href="#"><span class="icon-linkedin"></span></a>-->
...
<!--                        --><?//=Html::img('@web/images/person_3.jpg', ['class' => 'img-fluid'])?>
<!--                        <div class="social">-->
<!--                            <a href="#"><span class="icon-facebook"></span></a>-->
<!--                            <a href="#"><span class="icon-twitter"></span></a>-->
<!--                            <a href="#"><span class="icon-linkedin"></span></a>-->
...
<!--                        --><?//=Html::img('@web/images/person_4.jpg', ['class' => 'img-fluid'])?>
<!--                        <div class="social">-->
<!--                            <a href="#"><span class="icon-facebook"></span></a>-->
<!--                            <a href="#"><span class="icon-twitter"></span></a>-->
<!--                            <a href="#"><span class="icon-linkedin"></span></a>-->
                ...
                <div class="testimony-39291">
                    ...
                    <div class="d-flex vcard align-items-center">
                        <div class="pic mr-3">
                            ...
                            <?=Html::img('@web/images/person_4_sq.jpg', ['class' => 'img-fluid'])?>
                        </div>
                        <div class="text">
                            <strong class="d-block">John Doe</strong>
                            <span>CEO and Co-Founder</span>
            ...
            <div class="mb-4 mb-lg-0 col-md-6 col-lg-4">
                <div class="testimony-39291">
                    ...
                    <div class="d-flex vcard align-items-center">
                        <div class="pic mr-3">
                            <!--                                <img src="images/person_3_sq.jpg" alt="Image" class="img-fluid">-->
                            <?=Html::img('@web/images/person_3_sq.jpg', ['class' => 'img-fluid'])?>
                        </div>
                        <div class="text">
                            <strong class="d-block">John Doe</strong>
                            <span>CEO and Co-Founder</span>
...
<div class="site-section bg-image overlay" id="intro4">
    <div class="container">
